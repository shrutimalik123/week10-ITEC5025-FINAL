"""Script to generate PDF for the Beyond Week 10 paper."""
...
TXT_FILE = HERE / "BeyondWeek10_Part1_ShrutiMalik.txt"
PDF_FILE = HERE / "BeyondWeek10_Part1_ShrutiMalik.pdf"
...
class PaperPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 8, "Hypotify Clinical Chatbot - Beyond Week 10 | Shruti Malik",
...
def add_cover(pdf: PaperPDF):
    ...
    pdf.cell(0, 10, "ITEC5025 - Beyond Week 10",
             align="C", new_x="LMARGIN", new_y="NEXT")
    pdf.set_font("Helvetica", "B", 14)
    pdf.cell(0, 9, "Actions Beyond the 10th Week - Part 1",
             align="C", new_x="LMARGIN", new_y="NEXT")
    pdf.set_font("Helvetica", "", 10)
    pdf.cell(0, 8, "Accuracy Auditing, Behavioral Fixes, and What It Means to Test a Chatbot Honestly",
             align="C", new_x="LMARGIN", new_y="NEXT")
    ...
    pdf.cell(0, 8, "Author: Shruti Malik",
             align="C", new_x="LMARGIN", new_y="NEXT")
    pdf.cell(0, 8, "Date: March 25, 2026",
             align="C", new_x="LMARGIN", new_y="NEXT")
    ...
    lines = [
        "  This paper documents the post-Week 10 accuracy audit of the Hypotify Clinical",
        "  Chatbot. It explores running 100 questions against the live Streamlit engine,",
        "  diagnosing non-deterministic routing, resolving vocabulary gaps with regex",
        "  intercepts, and achieving a 100% pass rate. This document serves as",
        "  evidence of behavioral validation beyond synthetic test environments.",
    ]
    for ln in lines:
...
def build_pdf():
    ...
    while i < len(lines):
        ...
        # Numbered section headings "1. Deployment Method..." or "1. The Accuracy Audit..."
